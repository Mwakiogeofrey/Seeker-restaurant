...
const breakfast = [
    {
        ...
        description : "smoked bacon, sausage, tomato, mashrooms, black pudding, baked beans, eggs",
        price: "£12"
    },
    {
        id :2,
        name : "Avocado Toast",
        description : "poached eggs, avocado, onions,tomatoes, bread",
        price: "£8"
    ...
    },
    {
        id :3,
        name : "Barrito",
        description : "tortille, egg,cheese,potatoes, pork meat",
        price: "£11"
...
const lunch = [
    {
        id :1,
        name : "Caesar Salad",
        description : " chicken breast,romine lettuce, croutone, parmeson",
        price: "£15"
    },
    {
        id :2,
        name : "spaghetti carbonara",
        description : "spaghetti, pancette, garlic, eggs, parmesan ,pepper",
        price: "£14"
    ...
    },
    {
        id :3,
        name : "Pizza",
        description : " chorizo, italian salami, tonatoes, mushrooms",
        price: "£12"
...
const dessert = [
    {
        id :1,
        name : "Lemon Cake",
        description : "flour, suger, baking poweder, lemon",
        price: "£9"
    },
    {
        id :2,
        name : "Cinnamon Rolls",
        description : "flour, salt, suger, cinnamon, yeast,sour cream",
        price: "£11"
    ...
    },
    {
        id :3,
        name : "Vegan Pancakes",
        description : "flour, suger, baking powder, soya milk, blueberries",
        price: "£8 "
...
function Menu() {
    return (
        <div className="menu-page ">
            ...
            <div className="breakfast text-light bg-dark py-5">
                <div className="container">
                    <h2 className=" text-center fs-1 mb-4 mb-lg-5 text-uppercase fw-bold text-success">
                        Dessert
                    </h2>
